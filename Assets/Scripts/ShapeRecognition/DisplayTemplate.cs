...
public class DisplayTemplate : MonoBehaviour
{
    ...
    private readonly BaseRecognizeAlgorithm _BaseRecognizeAlgorithm = new BaseRecognizeAlgorithm();
    //private readonly DollarPRecognizer _dollarPRecognizer = new DollarPRecognizer();


    public void Draw(ShapeRecognizerManager.GestureTemplate gestureTemplate, BaseRecognizeAlgorithm.Step step)
    {
        Clear();
        ...
        /*if (step != BaseRecognizeAlgorithm.Step.RAW)
        {
        ...
        for (var i = 1; i < points.Length; i++)
        {
            ...
            if (step == BaseRecognizeAlgorithm.Step.TRANSLATED)
            {
