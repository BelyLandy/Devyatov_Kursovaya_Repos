...
namespace CW_Devyatov_238 {
    ...
    public class WaveManager : MonoBehaviour {
        ...
        private int currentWave = 0; //the number of the current active wave
        private int enemiesLeftInThisWave = 0; //the number of enemies left in this wave
        private  int totalEnemiesLeft = 0; //the number of all enemies left in this level
        ...
        void OnEnable() {
		    HealthController.OnUnitDeath += OnUnitDeath; //subscribe to event
	    }

	    void OnDisable() {
		    HealthController.OnUnitDeath -= OnUnitDeath; //unsubscribe to event
	    }
