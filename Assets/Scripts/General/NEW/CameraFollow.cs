...
public class CameraFollow : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (levelBound != null)
        {
            ...
            if (cameraRightEdge > levelBoundPos)
                Camera.main.transform.position = new Vector3(levelBoundPos - halfSize, Camera.main.transform.position.y,
    ...
    void ShowCameraView()
    {
        ...
        Vector2 bottomLeft =
            new Vector2(transform.position.x - cameraHalfWidth, transform.position.y - cameraHalfHeight);
